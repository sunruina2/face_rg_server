...
# summary_path = '../auroua_intf/mgpu_res/summary'  # the summary file save path
# premodel_path = '/Users/finup/Desktop/rg/face_rg_files/premodels/pm_insight_auroua/ckpt_model_d/InsightFace_iter_710000.ckpt'  # the ckpt file save path
# premodel_path = '../Insight_out/1030_auroua_out/sgpu_res/ckpt/InsightFace_iter_90000.ckpt'  # the ckpt file save path
premodel_path = '../insight_out/1030_auroua_out/sgpu_res/ckpt/InsightFace_iter_90000.ckpt'  # the ckpt file save path
